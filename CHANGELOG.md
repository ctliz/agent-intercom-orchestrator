...
- Distinguish Boss participant process/transport readiness from task activity, expose a dedicated exact-owned authenticated WorkerStore Intercom timestamp without treating launch baselines, manual renewals, or adoption as action, and classify active assignments stale after a bounded ten-minute first-action deadline while making unavailable source/tool telemetry explicit.
